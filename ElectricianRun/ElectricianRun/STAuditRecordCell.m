...
- (id)initWithStyle:(UITableViewCellStyle)style reuseIdentifier:(NSString *)reuseIdentifier
{
    ...
    if (self) {
        ...
        lbl=[[UILabel alloc]initWithFrame:CGRectMake(5, 75, 70, 30)];
        [lbl setFont:[UIFont systemFontOfSize:12]];
        [lbl setTextColor:[UIColor colorWithRed:(102/255.0) green:(102/255.0) blue:(102/255.0) alpha:1]];
        [lbl setTextAlignment:NSTextAlignmentRight];
        [lbl setText:@"是否完成:"];
        ...
        self.lbl5=[[UILabel alloc]initWithFrame:CGRectMake(80, 75, 70, 30)];
        ...
        lbl=[[UILabel alloc]initWithFrame:CGRectMake(160, 75, 70, 30)];
        [lbl setFont:[UIFont systemFontOfSize:12]];
        [lbl setTextColor:[UIColor colorWithRed:(102/255.0) green:(102/255.0) blue:(102/255.0) alpha:1]];
        [lbl setTextAlignment:NSTextAlignmentRight];
        [lbl setText:@"实际完成时间:"];
        ...
        self.lbl6=[[UILabel alloc]initWithFrame:CGRectMake(235, 75, 70, 30)];
